      ...
      <div className="pt-16 bg-black text-white min-h-screen">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-400">I build products that solve real problems.</p>
          </div>
          ...
          <section className="mb-12">
            <div className="bg-gray-900 rounded-lg p-8 text-center">
              ...
              <div className="max-w-4xl mx-auto space-y-6 text-gray-300">
                ...
                <p className="text-lg">
                  Founded in <span className="text-white font-semibold">2024</span>, my mission is
                  to help people build their dream products and companies. Every great business starts as an idea,
                  and I'm here to go through that journey with you from concept to reality.
                </p>
                <p className="text-lg">
                  Whether you're an entrepreneur with a vision, a business looking to innovate, 
                  or someone ready to bring their idea to life — I'm here to make that journey happen.
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="space-y-4 text-gray-300">
                    ...
                    <p>
                      From launching award-winning industrial equipment at Atlas Copco to building digital
